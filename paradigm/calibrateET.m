...
if strcmp(TASK, 'Resting')
    ...
    elseif TRAINING == 0 && strcmp(TASK, 'IAB')
        edfFile = [subjectID, '_IAB.edf'];
    elseif TRAINING == 1 && strcmp(TASK, 'IAB')
        edfFile = [subjectID, '_IAB_practice.edf'];
    end
...
try
    ...
    if strcmp(TASK, 'IAB')
        Eyelink('command', 'record_status_message "IAB EEG"');
    else
